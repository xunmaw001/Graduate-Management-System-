		...
		<div class="attr" :style='{"padding":"20px","position":"relative","background":"transparent","display":"flex"}'>
			...
			<div class="info" :style='{"width":"640px","padding":"10px","margin":"0 0 0 10px","background":"#F5F5F5"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>学位</div>
					<div  :style='{"padding":"0 10px","color":"#4D8CD0","background":"#fff","width":"498px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>{{detail.xuewei}}</div>
				</div>
