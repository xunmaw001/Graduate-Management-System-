<template>
  <div :style='{"width":"1200px","padding":"20px","margin":"10px auto","position":"relative","background":"#f5f5f5"}'>
    <div class="section-title" :style='{"margin":"10px 0 0","color":"#fff","borderRadius":"25px 25px 0 0","textAlign":"center","background":"#4D8CD0","fontSize":"20px","lineHeight":"54px"}'>公告信息</div>
