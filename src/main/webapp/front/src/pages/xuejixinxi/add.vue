...
<div :style='{"width":"1200px","padding":"20px","margin":"10px auto","position":"relative","background":"#f5f5f5"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"transparent"}' label="学校名称" prop="xuexiaomingcheng">
            <el-input v-model="ruleForm.xuexiaomingcheng" 
                placeholder="学校名称" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"transparent"}' label="入学时间" prop="ruxueshijian" >
              <el-date-picker
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"transparent"}' label="毕业时间" prop="biyeshijian" >
              <el-date-picker
                  format="yyyy 年 MM 月 dd 日"
                  value-format="yyyy-MM-dd"
                  v-model="ruleForm.biyeshijian" 
                  type="date"
                  placeholder="毕业时间">
              </el-date-picker> 
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"transparent"}' label="学籍情况" prop="xuejiqingkuang">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="学籍情况"
              v-model="ruleForm.xuejiqingkuang">
            </el-input>
          </el-form-item>
...
<script>
  export default {
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='biyeshijian'){
              this.ruleForm.biyeshijian = obj[o];
              continue;
            }
            if(o=='xuejiqingkuang'){
              this.ruleForm.xuejiqingkuang = obj[o];
              continue;
            }
          }
        }
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('xuejixinxi/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
                  ...
                  params: params
                     ...
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('xuejixinxi/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
