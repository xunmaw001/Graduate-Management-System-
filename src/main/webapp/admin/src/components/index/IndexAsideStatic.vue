		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","position":"relative","background":"#FFF"}' class="el-menu-vertical-demo" default-active="0">
				...
				<!-- <el-menu-item index="0" @click="menuHandler('')">
					<i v-if='true' :style='{"verticalAlign":"middle","margin":"0 3px","color":"inherit","textAlign":"center","width":"34px","fontSize":"18px","lineHeight":"1.5"}' class="el-icon-menu el-icon-s-home" />
					<span :style='{"verticalAlign":"middle","fontSize":"14px","lineHeight":"2","color":"inherit"}'>首页</span>
				</el-menu-item> -->
				...
				<el-submenu index="1">
					<template slot="title">
						<i v-if='true' :style='{"verticalAlign":"middle","margin":"0 3px","color":"inherit","textAlign":"center","width":"34px","fontSize":"18px","lineHeight":"1.5"}' class="el-icon-menu el-icon-user-solid" />
						<span :style='{"verticalAlign":"middle","fontSize":"14px","lineHeight":"2","color":"inherit"}'>个人中心</span>
					</template>
				...
				<el-submenu v-for=" (menu,index) in menuList.backMenu" :key="menu.menu" :index="index+2+''">
					<template slot="title">
						<i v-if='true' :style='{"verticalAlign":"middle","margin":"0 3px","color":"inherit","textAlign":"center","width":"34px","fontSize":"18px","lineHeight":"1.5"}' class="el-icon-menu" :class="icons[index]" />
						<span :style='{"verticalAlign":"middle","fontSize":"14px","lineHeight":"2","color":"inherit"}'>{{ menu.menu }}</span>
					</template>
	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","padding":"30px 0 0","margin":"-30px 0 0","background":"#EEEEEE","display":"none","minWidth":"150px","zIndex":"1"}
